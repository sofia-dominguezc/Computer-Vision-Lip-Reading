...
class DataModule(LightningDataModule):
    ...
    def train_dataloader(self):
        dataset = AVDataset(
            root_dir=self.args.train_root_dir,
            label_path=os.path.join(self.args.train_root_dir, self.args.train_file),
    ...
    def val_dataloader(self):
        dataset = AVDataset(
            root_dir=self.args.val_root_dir,
            label_path=os.path.join(self.args.val_root_dir, self.args.val_file),
            modality=self.args.modality,
    ...
    def test_dataloader(self):
        dataset = AVDataset(
            root_dir=self.args.test_root_dir,
            label_path=os.path.join(self.args.test_root_dir, self.args.test_file),
            modality=self.args.modality,
